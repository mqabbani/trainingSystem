                    ...
                    @foreach($allCourses as $course)
                        <tr>
                            ...
                            @if($course->status == 'Active')
                                <td style="font-size: 12px;font-family: cursive;color: red">{{$course->status}}</td>
                            @else
                                <td style="font-size: 12px;font-family: cursive;color: green">{{$course->status}}</td>
                            @endif

                            @if($course->type == 'Public')
                                <td style="font-size: 12px;font-family: cursive;color: green">{{$course->type}}</td>
                            @else
                                <td style="font-size: 12px;font-family: cursive;color: red">{{$course->type}}</td>
                            @endif
