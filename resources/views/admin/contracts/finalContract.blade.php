...
<body>
    <div class="container">
        ...
        <div class="row">
            ...
            <p class="text-right" dir="rtl" lang="ar" style="font-size: 18px;padding-right: 90px;">
    ...
    <div class="row">
        ...
        <p class="text-right" dir="rtl" lang="ar" style="font-size: 19px;padding-right: 90px;">
...
<b>تاسعا : القانون الواجب التطبيق</b>
        ...
        <p class="text-right" dir="rtl" lang="ar" style="font-size: 17px;padding-right: 90px;">
        شاهد ( ولي الأمر)
        </p>
        <p class="text-right" dir="rtl" lang="ar" style="font-size: 17px;padding-right: 90px;">
        الاسم :  
