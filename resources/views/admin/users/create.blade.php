          ...
          <div class="card-body">
              <div class="row form-group mr-4">
                  ...
                  <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                      <input type="text" class="form-control" style="font-family: cursive;" name="name" placeholder="Enter firstname">
                  </div>
              </div><!-- row -->
              <div class="row form-group mr-4">
                  <label class="col-sm-4 form-control-label" style="font-family: cursive;">Password: <span class="tx-danger">*</span></label>
                  <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                      <input type="password" style="font-family: cursive;" class="form-control" name="password" placeholder="Enter password" >
                  </div>
              </div>
              <div class="row form-group mr-4">
                  <label class="col-sm-4 form-control-label" style="font-family: cursive;">Email: <span class="tx-danger">*</span></label>
                  <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                      <input type="text" style="font-family: cursive;" class="form-control" name="email" placeholder="Enter email address" >
                  </div>
              </div>
